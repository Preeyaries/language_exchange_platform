  ...
  return (
    ...
    >
      ...
      <button
          ...
          className="absolute right-3 top-[10px] z-20 w-9 h-9 flex items-center justify-center
      bg-white/10 rounded-full border-0 cursor-pointer hover:bg-white/20 transition-colors"
      >
          <BellIcon />
          {unreadCount > 0 && (
             <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] bg-red-500 rounded-full
        text-white text-[10px] font-extrabold flex items-center justify-center px-1">
